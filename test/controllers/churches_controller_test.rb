...
class ChurchesControllerTest < ActionController::TestCase
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post :create, church: { address: @church.address, name: @church.name, phone: @church.phone, website: @church.website }
    end
  ...
  test "should update church" do
    patch :update, id: @church, church: { address: @church.address, name: @church.name, phone: @church.phone, website: @church.website }
    assert_redirected_to church_path(assigns(:church))
  end
